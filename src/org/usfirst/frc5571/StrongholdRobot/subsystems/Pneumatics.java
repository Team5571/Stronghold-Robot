...
public class Pneumatics extends Subsystem {
    ...
    private final Solenoid gearShift = RobotMap.pneumaticsGearShift;
    private final Solenoid arms = RobotMap.pneumaticsArms;
...
//    	armBoulderLauncher();
    ...
    public void setArmsUp() {
    	this.arms.set(Constants.ARMS_UP);
    }
    
    public void setArmsDown() {
    	this.arms.set(Constants.ARMS_DOWN);
    }
    
    public void setHighGear() {
    	this.gearShift.set(Constants.HIGH_GEAR);
    }

    public void setLowGear() {
    	this.gearShift.set(Constants.LOW_GEAR);
    }
